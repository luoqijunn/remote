...
CwindowWin::CwindowWin(int x, int y, int w, int h) :CwinBase(x, y, w, h)
{
	//创建CLabel对象
	this->cacLabel = new CLabel(25, 2, "窗戶控制器");
	this->openGateLabel = new CLabel(16, 5, "窗戶开启：");



	//添加按钮
	this->openGateButton = new CButton(14, 17, 18, 4, "          窗戶开/关");
