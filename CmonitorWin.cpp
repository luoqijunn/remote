...
CmonitorWin::CmonitorWin(int x, int y, int w, int h) :CwinBase(x, y, w, h)
{
	//创建CLabel对象
	this->cacLabel = new CLabel(25, 2, " 监控控制器");
	this->openGateLabel = new CLabel(16, 5, "监控开启：");



	//添加按钮
	this->openGateButton = new CButton(14, 17, 18, 4, "          监控开/关");
